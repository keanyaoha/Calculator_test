...
if country != def_country:
    ...
    tab_names = ["Travel", "Food", "Energy & Water", "Other"]
    selected_tab = st.session_state.tab_index

    def next_tab():
        if st.session_state.tab_index < len(tab_names) - 1:
    ...
    with col2:
        if selected_tab < len(tab_names) - 1:
